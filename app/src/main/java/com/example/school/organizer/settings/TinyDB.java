...
public class TinyDB {
     ...
     * default value int value returned if key was not found
    ...
    public ArrayList<Address> getListAddress(String key, Class<?> mClass){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Address value  = (Address) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public ArrayList<SearchSession> getListSearchSession(String key, Class<?> mClass){
        ...
        ArrayList<String> objStrings = getListString(key);
        ArrayList<SearchSession> objects =  new ArrayList<SearchSession>();
    ...
    public void putListAddress(String key, ArrayList<Address> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
